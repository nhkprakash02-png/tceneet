  ...
  return (
    <div>
      ...
      <div className="relative mb-4">
        ...
        <input type="text" placeholder='Search e.g. "2024" or "Physics"' value={searchQ} onChange={(e) => setSearchQ(e.target.value)} className="w-full rounded-lg pl-9 pr-3 py-2.5 text-sm" />
      </div>
