...
// NEET subjects are split by NCERT class level, which is how most NEET aspirants organize revision.
...
// The four NEET subjects, in the standard display order used across Mock Tests, Study
// Materials, and the Admin Panel.
export const NEET_SUBJECTS = ['physics', 'chemistry', 'botany', 'zoology'];
export const NEET_SUBJECT_LABELS = { physics: 'Physics', chemistry: 'Chemistry', botany: 'Botany', zoology: 'Zoology', full: 'Full Mock' };
...
// Accounts listed here get lifetime full access to every mock test/material (no paywalls, no
...
// Empty by default for this NEET deployment — add your own mentor/admin review accounts here.
export const EXEMPT_ADMIN_EMAILS = [
  // 'your-mentor-email@gmail.com',
];
