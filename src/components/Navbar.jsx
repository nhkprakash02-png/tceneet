        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-3">
          <button onClick={() => goTab('home')} className="flex items-center gap-2 shrink-0 min-w-0">
            ...
            <div className="min-w-0 text-left">
              <div className="font-display font-800 leading-tight text-xs sm:text-base truncate">TCE <span className="gold-text">NEET</span></div>
              <div className="text-[9px] sm:text-[10px] muted hidden md:block whitespace-nowrap">Your Path to NEET Success</div>
            </div>
          </button>
