...
export default function BatchesManager() {
  ...
  const addBatch = () => {
    const name = prompt('Batch name (e.g. "NEET Crash Course"):'); if (!name) return;
    const examCategory = prompt('Exam category tag (e.g. "NEET UG"):', 'NEET UG') || 'NEET UG';
  ...
  const editBatch = (id) => {
    ...
    const examCategory = prompt('Exam category tag:', b.examCategory || 'NEET UG'); if (examCategory === null) return;
