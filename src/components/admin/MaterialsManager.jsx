...
const CATS = [['physics', 'Physics'], ['chemistry', 'Chemistry'], ['botany', 'Botany'], ['zoology', 'Zoology']];
const MATERIAL_SUBCATEGORIES = { physics: ['Class 11', 'Class 12'], chemistry: ['Class 11', 'Class 12'], botany: ['Class 11', 'Class 12'], zoology: ['Class 11', 'Class 12'] };
