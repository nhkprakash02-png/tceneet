        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-8">
          {viewMode === 'paper' ? (
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-base sm:text-lg font-medium mb-4 leading-relaxed whitespace-pre-line">{q.textEn} {q.textBn && <span className="bn block text-sm muted mt-1">{q.textBn}</span>}</p>
              {q.image && <img src={q.image} alt="Question diagram" className="max-h-60 rounded-lg mb-5" />}
